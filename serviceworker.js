(function(self){
	...
	async function notify(){
		try{
			let obj=self.prepareNotificationObj.apply(this,arguments);
			if(self.pageChannel){
				await self.pageChannel.postMessage({subject:'notification',payload:obj});
			}else{
				await self.registration.showNotification(obj.title,obj);
			}
		}catch(e){
