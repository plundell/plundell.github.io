! function(e) {
    ...
    class O {
        constructor(e) {
            this.databaseName = e, this.emitter = new o, this.database = new c(this.databaseName)
        }
        static resetInstance() {
            O.databaseInstance = null
        }
        static get singletonInstance() {
            return O.databaseInstanceName || (O.databaseInstanceName = "ONE_SIGNAL_SDK_DB"), O.databaseInstance || (O.databaseInstance = new O(O.databaseInstanceName)), O.databaseInstance
        }
        ...
        shouldUsePostmam() {
            return m.a.getWindowEnv() !== h.a.ServiceWorker && S.b.isUsingSubscriptionWorkaround() && m.a.getTestEnv() === f.a.None
        }
        get(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                if (this.shouldUsePostmam()) return yield new Promise(i => Object(n.a)(this, void 0, void 0, function*() {
        ...
        getAll(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                if (this.shouldUsePostmam()) return yield new Promise(t => Object(n.a)(this, void 0, void 0, function*() {
        ...
        put(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                yield new Promise((i, o) => Object(n.a)(this, void 0, void 0, function*() {
                    m.a.getWindowEnv() !== h.a.ServiceWorker && S.b.isUsingSubscriptionWorkaround() && m.a.getTestEnv() === f.a.None ? OneSignal.proxyFrameHost.message(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_PUT, [{
                        table: e,
                        keypath: t
                    }], n => {
        ...
        remove(e, t) {
            return m.a.getWindowEnv() !== h.a.ServiceWorker && S.b.isUsingSubscriptionWorkaround() && m.a.getTestEnv() === f.a.None ? new Promise((i, n) => {
        ...
        getAppConfig() {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                return e.appId = t, e.subdomain = yield this.get("Options", "subdomain"), e.vapidPublicKey = yield this.get("Options", "vapidPublicKey"), e
            })
        }
        getExternalUserId() {
            return Object(n.a)(this, void 0, void 0, function*() {
        ...
        getServiceWorkerState() {
            return Object(n.a)(this, void 0, void 0, function*() {
                const e = new u;
                return e.workerVersion = yield this.get("Ids", "WORKER1_ONE_SIGNAL_SW_VERSION"), e
            })
        }
        ...
        resetSentUniqueOutcomes() {
            return Object(n.a)(this, void 0, void 0, function*() {
                const e = (yield this.getAll("SentUniqueOutcome")).map(e => (e.sentDuringSession = null, O.put("SentUniqueOutcome", e)));
                yield Promise.all(e)
            })
        }
        static rebuild() {
    ...
    class a {
        ...
        static trimUndefined(e) {
            for (const t in e) e.hasOwnProperty(t) && void 0 === e[t] && delete e[t];
            return e
        }
        static capitalize(e) {
    ...
    class f {
        ...
        static getIntegration(e) {
            return Object(o.a)(this, void 0, void 0, function*() {
                ...
                if (t) return i ? e ? a.a.SecureProxy : a.a.Secure : !d.b.isLocalhostAllowedAsSecureOrigin() || "localhost" !== location.hostname && "127.0.0.1" !== location.hostname ? a.a.InsecureProxy : a.a.Secure;
                if (i) {
                    return (yield f.isFrameContextInsecure()) ? a.a.InsecureProxy : e ? a.a.SecureProxy : a.a.Secure
                }
        ...
        static getOrigin() {
            return c.a.isBrowser() ? window.location.origin : "undefined" != typeof self && "undefined" != typeof ServiceWorkerGlobalScope ? self.location.origin : "Unknown"
        }
        static getWindowEnv() {
        ...
        static getOneSignalApiUrl(e = f.getApiEnv(), t) {
            switch (e) {
                case n.Development:
                    return f.isTurbineEndpoint(t) ? new URL(`https://localhost:${p}/api/v1`) : new URL(`https://localhost:${l}/api/v1`);
                case n.Staging:
    ...
    class p {
        ...
        broadcast(e, t) {
            return Object(o.a)(this, void 0, void 0, function*() {
                ...
                for (const n of i) d.a.debug(`[Worker Messenger] [SW -> Page] Broadcasting '${e.toString()}' to window client ${n.url}.`), n.postMessage({
                    command: e,
                    payload: t
                })
            })
        ...
        unicast(e, t, i) {
            return Object(o.a)(this, void 0, void 0, function*() {
                if (r.a.getWindowEnv() === a.a.ServiceWorker) {
                    ...
                    d.a.debug(`[Worker Messenger] [SW -> Page] Unicasting '${e.toString()}' to window client ${i.url}.`), i.postMessage({
                        command: e,
                        payload: t
                    })
        ...
        directPostMessageToSW(e, t) {
            return Object(o.a)(this, void 0, void 0, function*() {
                d.a.debug(`[Worker Messenger] [Page -> SW] Direct command '${e.toString()}' to service worker.`);
                const i = yield this.context.serviceWorkerManager.getRegistration();
                if (!i) return void d.a.error("`[Worker Messenger] [Page -> SW] Could not get ServiceWorkerRegistration to postMessage!");
                const n = u.a.getAvailableServiceWorker(i);
                n ? n.postMessage({
                    command: e,
                    payload: t
                }) : d.a.error("`[Worker Messenger] [Page -> SW] Could not get ServiceWorker to postMessage!")
            })
        }
        listen() {
            return Object(o.a)(this, void 0, void 0, function*() {
                if (!c.a.supportsServiceWorkers()) return;
                r.a.getWindowEnv() === a.a.ServiceWorker ? (self.addEventListener("message", this.onWorkerMessageReceivedFromPage.bind(this)), d.a.debug("[Worker Messenger] Service worker is now listening for messages.")) : yield this.listenForPage()
            })
        }
        listenForPage() {
            return Object(o.a)(this, void 0, void 0, function*() {
                navigator.serviceWorker.addEventListener("message", this.onPageMessageReceivedFromServiceWorker.bind(this)), d.a.debug(`(${location.origin}) [Worker Messenger] Page is now listening for messages.`)
            })
        }
        onWorkerMessageReceivedFromPage(e) {
            ...
            const i = this.replies.findListenersForMessage(t.command),
                n = [],
                o = [];
            d.a.debug("[Worker Messenger] Service worker received message:", e.data);
    ...
    (function(e) {
        ...
        class u {
            ...
            static isUsingSubscriptionWorkaround() {
                ...
                return u.internalIsUsingSubscriptionWorkaround(OneSignal.config.subdomain, t)
            }
            ...
            static logMethodCall(e, ...t) {
                return c.a.debug(`Called %c${e}(${t.map(d.a.stringify).join(", ")})`, d.a.getConsoleStyle("code"), ".")
            }
            static isHttps() {
                return u.isSafari() ? "https:" === window.location.protocol : !u.isUsingSubscriptionWorkaround()
            }
            static isSafari() {
    ...
    n = function() {
        ...
        function t(t) {
            ...
            }, !n.msedge && /(apple)?webkit/i.test(t) ? (/(apple)?webkit\/537\.36/i.test(t) ? (n.name = n.name || "Blink", n.blink = e) : (n.name = n.name || "Webkit", n.webkit = e), !n.version && y && (n.version = y)) : !n.opera && /gecko\//i.test(t) && (n.name = n.name || "Gecko", n.gecko = e, n.version = n.version || i(/gecko\/(\d+(\.\d+)?)/i)), n.windowsphone || n.msedge || !a && !n.silk ? n.windowsphone || n.msedge || !r ? v ? n.mac = e : P ? n.xbox = e : b ? n.windows = e : m && (n.linux = e) : (n[r] = e, n.ios = e) : n.android = e;
            var I = "";
            ...
            }(i(/Windows ((NT|XP)( \d\d?.\d)?)/i)) : n.windowsphone ? I = i(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : n.mac ? I = (I = i(/Mac OS X (\d+([_\.\s]\d+)*)/i)).replace(/[_\s]/g, ".") : r ? I = (I = i(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(/[_\s]/g, ".") : a ? I = i(/android[ \/-](\d+(\.\d+)*)/i) : n.webos ? I = i(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : n.blackberry ? I = i(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : n.bada ? I = i(/bada\/(\d+(\.\d+)*)/i) : n.tizen && (I = i(/tizen[\/\s](\d+(\.\d+)*)/i)), I && (n.osversion = I);
    ...
    class c {
        static getPlayer(e, t) {
            return r.b.enforceAppId(e), r.b.enforcePlayerId(t), s.b.get(`players/${t}?app_id=${e}`)
        }
        static updatePlayer(e, t, i) {
            return r.b.enforceAppId(e), r.b.enforcePlayerId(t), s.b.put(`players/${t}`, Object.assign({
                app_id: e
            }, i))
        }
        static sendNotification(e, t, i, n, o, a, c, d) {
            ...
            return i && (u.headings = i), o && (u.url = o), a && (u.chrome_web_icon = a, u.firefox_icon = a), r.b.trimUndefined(u), s.b.post("notifications", u)
        }
        static createUser(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const t = e.serialize();
        ...
        static updateUserSession(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                try {
                    ...
                    throw e && Array.isArray(e.errors) && e.errors.length > 0 && r.b.contains(e.errors[0], "app_id not found") ? new o.a(o.b.MissingAppId) : e
                }
            })
        }
        ...
        static trigger(e, t, i = null) {
            return Object(n.a)(this, void 0, void 0, function*() {
                if (!c.b.contains(d, e)) {
                    ...
                    i && (o = `${o} â¬¸ ${c.b.capitalize(i)}`), n || !1 === n ? a.a.debug(`(${o}) Â» %c${e}:`, c.b.getConsoleStyle("event"), n) : a.a.debug(`(${o}) Â» %c${e}`, c.b.getConsoleStyle("event"))
                }
                if (o.a.isBrowser()) {
                ...
                if (o.a.isBrowser() && (s.a.getWindowEnv() === r.a.OneSignalSubscriptionPopup || s.a.getWindowEnv() === r.a.OneSignalProxyFrame)) {
                    opener || parent ? c.b.contains(u, e) && (s.a.getWindowEnv() === r.a.OneSignalSubscriptionPopup ? OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.REMOTE_RETRIGGER_EVENT, {
                        eventName: e,
                        eventData: t
    ...
    class InvalidArgumentError extends o.a {
        constructor(e, t) {
            ...
            super(i), this.argument = e, this.reason = n[t], Object.setPrototypeOf(this, InvalidArgumentError.prototype)
        }
    }
}, function(e, t, i) {
    "use strict";
    ...
    class c {
        ...
        static call(e, t, i, s) {
            ...
            const d = new Headers;
            if (d.append("Origin", o.a.getOrigin()), d.append("SDK-Version", `onesignal/web/${n.a.version()}`), d.append("Content-Type", "application/json;charset=UTF-8"), s)
            ...
            let l;
            return i && (u.body = JSON.stringify(i)), fetch(o.a.getOneSignalApiUrl(void 0, t).toString() + "/" + t, u).then(e => (l = e.status, e.json())).then(e => {
                if (l >= 200 && l < 300) return e;
                if ("no-user-id-error" !== c.identifyError(e)) return Promise.reject(e)
            }).catch(e => (a.a.warn(`Could not complete request to /${t}`, e), Promise.reject(e)))
        }
    ...
    class v {
        ...
        beforeOutcomeSend() {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                return Object(f.e)(e, this.outcomeName), this.config ? this.outcomeName ? (yield Object(f.b)(), !!(yield OneSignal.privateIsPushNotificationsEnabled()) || (p.a.warn("Reporting outcomes is supported only for subscribed users."), !1)) : (p.a.error("Outcome name is required"), !1) : (p.a.debug("Outcomes feature not supported by main application yet."), !1)
            })
        }
        getAttributedNotifsByUniqueOutcomeName() {
            return Object(n.a)(this, void 0, void 0, function*() {
                return (yield c.a.getAll("SentUniqueOutcome")).filter(e => e.outcomeName === this.outcomeName).reduce((e, t) => {
        ...
        saveSentUniqueOutcome(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const t = this.outcomeName,
                    i = yield c.a.get("SentUniqueOutcome", t), n = yield c.a.getCurrentSession(), o = [...i ? i.notificationIds : [], ...e], s = n ? n.startTimestamp : null;
        ...
        wasSentDuringSession() {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                if (!e) return !1;
                const t = yield c.a.getCurrentSession(), i = t && e.sentDuringSession === t.startTimestamp, n = !t && !!e.sentDuringSession;
                return i || n
            })
        }
        send(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    ...
                    case l.a.Unattributed:
                        if (this.isUnique) {
                            if (yield this.wasSentDuringSession()) return void p.a.warn("(Unattributed) unique outcome was already sent during this session");
                    ...
                    default:
                        return void p.a.warn("You are on a free plan. Please upgrade to use this functionality.")
                }
            })
        }
        static getAttribution(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                if (e.indirect && e.indirect.enabled) {
                    ...
                    if (p.a.debug(`\tFound total of ${n.length} received notifications`), n.length > 0) {
                        ...
                        p.a.debug(`\tTotal of ${s.length} received notifications are within reporting window.`);
                        const r = o.filter(e => -1 === s.indexOf(e.notificationId)).map(e => e.notificationId);
                        if (r.forEach(e => c.a.remove("NotificationReceived", e)), p.a.debug(`\t${r.length} received notifications will be deleted.`), s.length > 0) return {
                            type: l.a.Indirect,
                            notificationIds: s
                        }
                    }
                ...
                return e.unattributed && e.unattributed.enabled ? {
                    type: l.a.Unattributed,
                    notificationIds: []
                } : {
                    type: l.a.NotSupported,
                    notificationIds: []
                }
            })
        }
    ...
    class w {
        ...
        static appendServiceWorkerParams(e, t, i) {
            return `${new URL(e,a.a.getBaseUrl()).href}?${g.b.encodeHashAsUriComponent({appId:t})}?${g.b.encodeHashAsUriComponent({sdkVersion:i})}`
        }
        static upsertSession(e, t, i, o, a, d) {
            return Object(n.a)(this, void 0, void 0, function*() {
                if (!o) return void s.a.error("No deviceId provided for new session.");
                if (!i.app_id) return void s.a.error("No appId provided for new session.");
                ...
                if (!n) {
                    ...
                    return n && (t.notificationId = n.notificationId), yield c.a.upsertSession(t), void(yield w.sendOnSessionCallIfNecessary(a, i, o, t))
                }
                if (n.status === r.c.Active) return void s.a.debug("Session already active", n);
                if (!n.lastDeactivatedTimestamp) return void s.a.debug("Session is in invalid state", n);
                const u = (new Date).getTime();
                if (w.timeInSecondsBetweenTimestamps(u, n.lastDeactivatedTimestamp) <= e) return n.status = r.c.Active, n.lastActivatedTimestamp = u, n.lastDeactivatedTimestamp = null, void(yield c.a.upsertSession(n));
                ...
                yield c.a.upsertSession(l), yield w.sendOnSessionCallIfNecessary(a, i, o, l)
            })
        }
        static deactivateSession(e, t, i) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const n = yield c.a.getCurrentSession();
                if (!n) return void s.a.debug("No active session found. Cannot deactivate.");
                if (n.status === r.c.Inactive) return Object(y.a)(() => w.finalizeSession(n, t, i), e);
                if (n.status !== r.c.Active) return void s.a.warn(`Session in invalid state ${n.status}. Cannot deactivate.`);
        ...
        static sendOnSessionCallIfNecessary(e, t, i, s) {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                n !== i && (s.deviceId = n, yield Promise.all([c.a.setDeviceId(n), c.a.upsertSession(s), c.a.resetSentUniqueOutcomes()])), yield(new O.a).synchronizer.onSession()
            })
        }
        static finalizeSession(e, t, i) {
            return Object(n.a)(this, void 0, void 0, function*() {
                if (s.a.debug("Finalize session", `started: ${new Date(e.startTimestamp)}`, `duration: ${e.accumulatedDuration}s`), t) {
                    s.a.debug(`send on_focus reporting session duration -> ${e.accumulatedDuration}s`);
                    const t = yield v.getAttribution(i);
                    s.a.debug("send on_focus with attribution", t), yield o.a.sendSessionDuration(e.appId, e.deviceId, e.accumulatedDuration, e.deviceType, t), yield(new O.a).synchronizer.onFocus(e.accumulatedDuration)
                }
                yield Promise.all([c.a.cleanupCurrentSession(), c.a.removeAllNotificationClicked()]), s.a.debug("Finalize session finished", `started: ${new Date(e.startTimestamp)}`)
            })
        }
        static timeInSecondsBetweenTimestamps(e, t) {
            return e <= t ? 0 : Math.floor((e - t) / 1e3)
        }
    }(S = m || (m = {})).OneSignalWorker = "OneSignal Worker", S.ThirdParty = "3rd Party", S.None = "None", S.Indeterminate = "Indeterminate"
}, function(e, t, i) {
    "use strict";
    var n;
    i.d(t, "a", function() {
    ...
    class SdkInitError extends o.a {
        constructor(e, t) {
            ...
            super(i), this.reason = n[e], Object.setPrototypeOf(this, SdkInitError.prototype)
        }
    }
}, function(e, t, i) {
    "use strict";
    ...
    class NotSubscribedError extends o.a {
        constructor(e) {
            ...
            super(t), this.reason = n[e], Object.setPrototypeOf(this, NotSubscribedError.prototype)
        }
    }
}, function(e, t, i) {
    "use strict";
    ...
    class d {
        ...
        static updatePlayer(e, t, i) {
            return Object(n.a)(this, void 0, void 0, function*() {
                return yield a.a.enforceAppIdAndPlayerId(e, t, () => Object(n.a)(this, void 0, void 0, function*() {
                    yield o.a.put(`players/${t}`, Object.assign({
                        app_id: e
                    }, i))
                }))
            })
        ...
        static updateUserSession(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                return yield a.a.enforceAppIdAndPlayerId(t.app_id, e, () => Object(n.a)(this, void 0, void 0, function*() {
        ...
        static sendSessionDuration(e, t, i, s, r) {
            return Object(n.a)(this, void 0, void 0, function*() {
                a.a.enforceAppIdAndPlayerId(e, t, () => Object(n.a)(this, void 0, void 0, function*() {
                    const n = {
                        app_id: e,
                        type: 1,
                        state: "ping",
    ...
    i.d(t, "a", function() {
        ...
        function(e) {
            e[e.ChromeLike = 5] = "ChromeLike", e[e.Safari = 7] = "Safari", e[e.Firefox = 8] = "Firefox", e[e.Email = 11] = "Email", e[e.Edge = 12] = "Edge", e[e.SMS = 14] = "SMS"
        }(n || (n = {}))
}, function(e, t, i) {
    "use strict";
    i.d(t, "a", function() {
    ...
    class d {
        constructor() {
            this.language = s.a.getLanguage(), this.timezone = -60 * (new Date).getTimezoneOffset(), this.timezoneId = Intl.DateTimeFormat().resolvedOptions().timeZone;
        ...
        serialize() {
            ...
            return this.appId && (e.app_id = this.appId), this.externalUserId && (e.external_user_id = this.externalUserId), this.externalUserIdAuthHash && (e.external_user_id_auth_hash = this.externalUserIdAuthHash), e
        }
        deserialize(e) {
            throw new r.a
        }
    ...
    class n {
        constructor(e, t, i) {
            this.subscriptionId = e, this.identifier = t, this.identifierAuthHash = i
        }
        serialize() {
            return {
    ...
    function r(e, t) {
        ...
        const c = new Promise((t, s) => {
            let c = !1;
            r = self.setTimeout(() => Object(n.a)(this, void 0, void 0, function*() {
                c = !0;
                try {
                    yield e(), t()
                } catch (e) {
        ...
        static getRegistration(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                try {
                    ...
                    return o.a.warn("[Service Worker Status] Error Checking service worker registration", e, t), null
                }
            })
        }
        static getAvailableServiceWorker(e) {
            const t = e.active || e.installing || e.waiting;
            return t || o.a.warn("Could not find an available ServiceWorker instance!"), t
        }
    }
}, function(e, t, i) {
    "use strict";
    ...
    class p {
        ...
        getReportedNotificationPermission(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (d.b.isUsingSubscriptionWorkaround()) return yield this.getOneSignalSubdomainNotificationPermission(e); {
        ...
        isPermissionEnvironmentAmbiguous(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                return !t.safari && !t.firefox && e === n.Denied && (this.isCurrentFrameContextCrossOrigin() || (yield s.a.isFrameContextInsecure()) || d.b.isUsingSubscriptionWorkaround())
            })
        }
    ...
    class v {
        ...
        setPageViewCount(e) {
            try {
                sessionStorage.setItem(v.SESSION_STORAGE_KEY_NAME, e.toString()), s.a.getWindowEnv() === r.a.OneSignalSubscriptionPopup && OneSignal.subscriptionPopup && OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.SET_SESSION_COUNT)
            } catch (e) {}
        }
        incrementPageViewCount() {
            ...
            this.setPageViewCount(e), this.setLocalPageViewCount(t), this.incrementedPageViewCount = !0, a.a.debug(`Incremented page view count: newCountSingleTab: ${e},\n      newCountAccrossTabs: ${t}.`)
        }
    ...
    class k extends I.a {
        constructor(e, t) {
            super("Registration of a Service Worker failed."), this.status = e, this.statusText = t, Object.setPrototypeOf(this, k.prototype)
        }
    }
    var C = k,
        E = i(20),
    ...
    class A {
        ...
        getRegistration() {
            return Object(c.a)(this, void 0, void 0, function*() {
                return yield N.a.getRegistration(this.config.registrationOptions.scope)
            })
        }
        getActiveState() {
            return Object(c.a)(this, void 0, void 0, function*() {
        ...
        static activeSwFileName(e) {
            ...
            if ("akam-sw.js" == n) {
                ...
                if (e) return a.a.debug("Found a ServiceWorker under Akamai's akam-sw.js?othersw=", e), new S(new URL(e).pathname).getFileName()
            }
            return n
        }
        swActiveStateByFileName(e) {
            return e ? e == this.config.workerPath.getFileName() ? E.a.OneSignalWorker : E.a.ThirdParty : E.a.None
        }
        getWorkerVersion() {
            return Object(c.a)(this, void 0, void 0, function*() {
                return new Promise(e => Object(c.a)(this, void 0, void 0, function*() {
                    ...
                    } else this.context.workerMessenger.once(o.b.WorkerVersion, t => {
                        e(t)
        ...
        shouldInstallWorker() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (OneSignal.config.subdomain && "safari" !== OneSignal.environmentInfo.browserType && s.a.getWindowEnv() === r.a.Host) return !1;
                const e = yield this.getActiveState();
                if (a.a.debug("[shouldInstallWorker] workerState", e), e === E.a.None || e === E.a.ThirdParty) {
                    const e = "granted" === (yield OneSignal.context.permissionManager.getNotificationPermission(OneSignal.config.safariWebId));
                    return e && a.a.info("[shouldInstallWorker] Notification Permissions enabled, will install ServiceWorker"), e
                }
        ...
        haveParamsChanged() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (!e) return a.a.info("[changedServiceWorkerParams] workerRegistration not found at scope", this.config.registrationOptions.scope), !0;
                const t = new URL(e.scope).pathname,
                    i = this.config.registrationOptions.scope;
                if (t != i) return a.a.info("[changedServiceWorkerParams] ServiceWorker scope changing", {
                    a_old: t,
                    b_new: i
                }), !0;
                const n = N.a.getAvailableServiceWorker(e),
                    o = E.b.getServiceWorkerHref(this.config, this.context.appConfig.appId, m.a.version());
                return null === n || void 0 === n || !n.scriptURL || o !== n.scriptURL && (a.a.info("[changedServiceWorkerParams] ServiceWorker href changing:", {
        ...
        workerNeedsUpdate() {
            return Object(c.a)(this, void 0, void 0, function*() {
                let e;
                a.a.info("[Service Worker Update] Checking service worker version...");
                try {
                    e = yield x.a.timeoutPromise(this.getWorkerVersion(), 2e3)
                } catch (e) {
                    return a.a.info("[Service Worker Update] Worker did not reply to version query; assuming older version and updating."), !0
                }
                return e !== m.a.version() ? (a.a.info(`[Service Worker Update] Updating service worker from ${e} --\x3e ${m.a.version()}.`), !0) : (a.a.info(`[Service Worker Update] Service worker version is current at ${e} (no update required).`), !1)
            })
        }
        establishServiceWorkerChannel() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                e.off(), e.on(o.b.NotificationDisplayed, e => Object(c.a)(this, void 0, void 0, function*() {
                    a.a.debug(location.origin, "Received notification display event from service worker."), yield P.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e)
                })), e.on(o.b.NotificationClicked, e => Object(c.a)(this, void 0, void 0, function*() {
                    let t;
                    if (0 === (t = s.a.getWindowEnv() === r.a.OneSignalProxyFrame ? yield new Promise(e => {
                        ...
                        a.a.debug("notification.clicked event received, but no event listeners; storing event in IndexedDb for later retrieval.");
                        let t = e.url;
                        e.url || (t = location.href), yield y.a.put("NotificationOpened", {
                            url: t,
                            data: e,
                            timestamp: Date.now()
                        })
                    ...
                    a.a.debug(`${s.a.getWindowEnv().toString()} Picked up command.redirect to ${e}, forwarding to host page.`);
                    const t = OneSignal.proxyFrame;
                    t && t.messenger.message(OneSignal.POSTMAM_COMMANDS.SERVICEWORKER_COMMAND_REDIRECT, e)
                }), e.on(o.b.NotificationDismissed, e => Object(c.a)(this, void 0, void 0, function*() {
                    yield P.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e)
                }));
                const t = d.b.isHttps(),
                    i = d.b.isSafari();
                e.on(o.b.AreYouVisible, n => Object(c.a)(this, void 0, void 0, function*() {
                    if (t && i) {
                        const t = {
        ...
        installWorker() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                a.a.info("Installing worker..."), (yield this.getActiveState()) === E.a.ThirdParty && a.a.info("[Service Worker Installation] 3rd party service worker detected.");
                const e = E.b.getServiceWorkerHref(this.config, this.context.appConfig.appId, m.a.version()),
                    t = `${d.b.getBaseUrl()}${this.config.registrationOptions.scope}`;
                a.a.info(`[Service Worker Installation] Installing service worker ${e} ${t}.`);
                try {
                    yield navigator.serviceWorker.register(e, {
                        scope: t
                    })
                } catch (t) {
                    if (a.a.error(`[Service Worker Installation] Installing service worker failed ${t}`), s.a.getWindowEnv() === r.a.OneSignalSubscriptionPopup) throw t;
                    const i = yield fetch(e);
                    if (403 === i.status || 404 === i.status) throw new C(i.status, i.statusText);
                    throw t
                }
                a.a.debug("[Service Worker Installation] Service worker installed."), yield this.establishServiceWorkerChannel()
            })
        }
    }
    var T, M, _, j, D, U = i(13),
        W = i(22),
        R = i(12),
        F = i(31);
    ! function(e) {
    ...
    }(T || (T = {})), (_ = M || (M = {}))[_.MissingAppId = 0] = "MissingAppId", _[_.RedundantPermissionMessage = 1] = "RedundantPermissionMessage", _[_.PushPermissionAlreadyGranted = 2] = "PushPermissionAlreadyGranted", _[_.UnsupportedEnvironment = 3] = "UnsupportedEnvironment", _[_.MissingDomElement = 4] = "MissingDomElement", _[_.ServiceWorkerNotActivated = 5] = "ServiceWorkerNotActivated", _[_.NoProxyFrame = 6] = "NoProxyFrame";
    class B extends I.a {
        constructor(e, t) {
            let i;
            switch (e) {
                ...
                case M.RedundantPermissionMessage:
                    let n = "";
                    t && t.permissionPromptType && (n = `(${T[t.permissionPromptType]})`), i = `Another permission message ${n} is being displayed.`;
                    break;
            ...
            super(i), this.description = M[e], this.reason = e, Object.setPrototypeOf(this, B.prototype)
        }
    }(D = j || (j = {}))[D.Blocked = 0] = "Blocked", D[D.Dismissed = 1] = "Dismissed", D[D.Default = 2] = "Default";
    class V extends I.a {
        constructor(e) {
            let t;
            switch (e) {
    ...
    var L, H, SdkInitError = i(24);
    (H = L || (L = {}))[H.InvalidSafariSetup = 0] = "InvalidSafariSetup", H[H.Blocked = 1] = "Blocked", H[H.Dismissed = 2] = "Dismissed";
    class $ extends I.a {
        constructor(e) {
            let t;
            switch (e) {
    ...
    class K {
        ...
        subscribe(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    ...
                    case r.a.OneSignalSubscriptionModal:
                    case r.a.OneSignalSubscriptionPopup:
                        if ((yield OneSignal.privateGetNotificationPermission()) === n.Denied) throw new V(j.Blocked);
                        if (K.isSafari()) {
                            i = yield this.subscribeSafari(), a.a.info("Installing SW on Safari");
                            try {
                                yield this.context.serviceWorkerManager.installWorker(), a.a.info("SW on Safari successfully installed")
                            } catch (e) {
        ...
        registerSubscription(e, t) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                return o.deviceId = n, o.optedOut = !1, e ? K.isSafari() ? o.subscriptionToken = e.safariDeviceToken : o.subscriptionToken = e.w3cEndpoint ? e.w3cEndpoint.toString() : null : o.subscriptionToken = null, yield y.a.setSubscription(o), s.a.getWindowEnv() !== r.a.ServiceWorker && P.a.trigger(OneSignal.EVENTS.REGISTERED), "undefined" != typeof OneSignal && (OneSignal._sessionInitAlreadyRunning = !1), o
            })
        }
        ...
        associateSubscriptionWithEmail(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                t.subscriptionId && (yield U.a.updatePlayer(this.config.appId, e, {
                    parent_player_id: t.subscriptionId,
                    email: t.identifier
                }))
            })
        ...
        subscribeSafariPromptPermission() {
            return new Promise(e => {
                window.safari.pushNotification.requestPermission(`${s.a.getOneSignalApiUrl().toString()}/safari`, this.config.safariWebId, {
        ...
        subscribeSafari() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (z.a.triggerNotificationPermissionChanged(), !i) throw new $(L.InvalidSafariSetup);
                return e.setFromSafariSubscription(i), e
            })
        }
        subscribeFcmFromPage(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                if (s.a.getWindowEnv() !== r.a.ServiceWorker && Notification.permission === n.Default) {
                    yield P.a.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED);
                    const e = yield K.requestPresubscribeNotificationPermission();
                    switch (e === n.Default && (yield z.a.triggerNotificationPermissionChanged(!0)), e) {
                        case n.Default:
                            throw a.a.debug("Exiting subscription and not registering worker because the permission was dismissed."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new V(j.Dismissed);
                        case n.Denied:
                            throw a.a.debug("Exiting subscription and not registering worker because the permission was blocked."), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new V(j.Blocked)
                    }
                }
                try {
                    yield this.context.serviceWorkerManager.installWorker()
                } catch (e) {
                    throw e instanceof C && (403 === e.status ? yield this.context.subscriptionManager.registerFailedSubscription(R.a.ServiceWorkerStatus403, this.context): 404 === e.status && (yield this.context.subscriptionManager.registerFailedSubscription(R.a.ServiceWorkerStatus404, this.context))), e
                }
                a.a.debug("[Subscription Manager] Getting OneSignal service Worker...");
                const t = yield this.context.serviceWorkerManager.getRegistration();
                if (!t) throw new Error("OneSignal service worker not found!");
                return a.a.debug("[Subscription Manager] Service worker is ready to continue subscribing."), yield this.subscribeWithVapidKey(t.pushManager, e)
            })
        }
        subscribeFcmFromWorker(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                const t = self.registration;
                if (!t.active && !l.a.firefox) throw new B(M.ServiceWorkerNotActivated);
        ...
        subscribeWithVapidKey(e, t) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                switch (t) {
                    case 0:
                        if (!i) break;
                        i.options ? a.a.debug("[Subscription Manager] An existing push subscription exists and it's options is not null.") : (a.a.debug("[Subscription Manager] An existing push subscription exists and options is null. Unsubscribing from push first now."), yield K.doPushUnsubscribe(i));
                        break;
                    case 1:
                ...
                return i && (s.existingW3cPushSubscription = W.a.setFromW3cSubscription(i)), s
            })
        }
        static updateSubscriptionTime(e, t) {
            return Object(c.a)(this, void 0, void 0, function*() {
                const i = yield y.a.getSubscription();
                e && (i.createdAt = (new Date).getTime()), i.expirationTime = t, yield y.a.setSubscription(i)
            })
        }
        static doPushUnsubscribe(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                a.a.debug("[Subscription Manager] Unsubscribing existing push subscription.");
                const t = yield e.unsubscribe();
                return a.a.debug(`[Subscription Manager] Unsubscribing existing push subscription result: ${t}`), t
            })
        }
        static doPushSubscribe(e, t) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                a.a.debug("[Subscription Manager] Subscribing to web push with these options:", i);
                try {
                    const t = yield e.getSubscription();
                    return [yield e.subscribe(i), !t]
                } catch (t) {
                    if ("InvalidStateError" == t.name) {
                        a.a.warn("[Subscription Manager] Couldn't re-subscribe due to applicationServerKey changing, unsubscribe and attempting to subscribe with new key.", t);
                        const n = yield e.getSubscription();
                        return n && (yield K.doPushUnsubscribe(n)), [yield e.subscribe(i), !0]
                    }
                    throw t
                }
            })
        ...
        isSubscriptionExpiring() {
            return Object(c.a)(this, void 0, void 0, function*() {
                const e = yield s.a.getIntegration(), t = s.a.getWindowEnv();
                switch (e) {
                    case O.a.Secure:
        ...
        isSubscriptionExpiringForSecureIntegration() {
            return Object(c.a)(this, void 0, void 0, function*() {
                if ((yield this.context.serviceWorkerManager.getActiveState()) !== E.a.OneSignalWorker) return !1;
                const e = yield this.context.serviceWorkerManager.getRegistration();
                if (!e) return !1;
        ...
        getSubscriptionStateForSecure() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                const i = yield this.context.serviceWorkerManager.getActiveState(), o = yield this.context.serviceWorkerManager.getRegistration(), s = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId), r = i === E.a.OneSignalWorker;
                return o ? {
                    subscribed: !(!e || s !== n.Granted || !r),
                    optedOut: !!t
                } : {
                    subscribed: !1,
                    optedOut: !!t
        ...
        getSubscriptionStateForInsecure() {
            return Object(c.a)(this, void 0, void 0, function*() {
                const {
                    ...
                    subscriptionToken: t,
                    optedOut: i
                } = yield y.a.getSubscription(), o = yield this.context.permissionManager.getNotificationPermission(this.context.appConfig.safariWebId);
                return {
                    subscribed: !(!e || !t || o !== n.Granted),
                    optedOut: !!i
                }
            })
        }
        registerFailedSubscription(e, t) {
            return Object(c.a)(this, void 0, void 0, function*() {
                t.pageViewManager.isFirstPageView() && (t.subscriptionManager.registerSubscription(new W.a, e), t.pageViewManager.incrementPageViewCount())
            })
        }
    }
    var G = class {
            static getServiceWorkerManager(e) {
                ...
                return t.userConfig && (t.userConfig.path && (n.workerPath = new S(`${t.userConfig.path}${t.userConfig.serviceWorkerPath}`)), t.userConfig.serviceWorkerParam && (n.registrationOptions = t.userConfig.serviceWorkerParam)), new A(e, n)
            }
    ...
    class q {
        static put(e, t) {
            return void 0 === q.store[e] && (q.store[e] = [null, null]), q.store[e].push(t), q.store[e].length == q.LIMIT + 1 && q.store[e].shift(), q.store[e]
        }
        static get(e) {
    ...
    class ee {
        ...
        initialize() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if ((null === (e = this.config) || void 0 === e ? void 0 : e.enabled) && (yield this.loadSdkStyles()))
                    if (a.a.info("OneSignal: initializing customlink"), (null === (t = this.config) || void 0 === t ? void 0 : t.unsubscribeEnabled) || !ee.isPushEnabled())
        ...
        injectMarkup(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                e.innerHTML = "", yield this.mountExplanationNode(e), yield this.mountSubscriptionNode(e)
            })
        }
            ...
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (null === (t = this.config) || void 0 === t ? void 0 : t.text) {
                    if (this.config.text.explanation) {
                        ...
                        t.textContent = this.config.text.explanation, Object(Z.a)(t, Q.resetClass), Object(Z.a)(t, Q.explanationClass), this.config.size && Object(Z.a)(t, this.config.size), ee.isPushEnabled() ? Object(Z.a)(t, Q.state.subscribed) : Object(Z.a)(t, Q.state.unsubscribed), e.appendChild(t)
                    }
        ...
        loadSdkStyles() {
            return Object(c.a)(this, void 0, void 0, function*() {
                return 0 === (yield OneSignal.context.dynamicResourceLoader.loadSdkStylesheet()) || (a.a.debug("Not initializing custom link button because styles failed to load."), !1)
            })
        }
        hideElement(e) {
            Object(Z.a)(e, Q.hide)
        ...
        handleClick(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                var t, i;
                if (ee.isPushEnabled()) yield OneSignal.setSubscription(!1), yield this.setTextFromPushStatus(e);
                else {
                    if (!ee.isOptedOut()) {
                        const e = {
                            autoAccept: !OneSignal.environmentInfo.requiresUserInteraction
                        };
                        return yield OneSignal.registerForPushNotifications(e), void(!(null === (t = this.config) || void 0 === t ? void 0 : t.unsubscribeEnabled) && ee.isPushEnabled() && this.hideCustomLinkContainers())
                    }
                    yield OneSignal.setSubscription(!0), !(null === (i = this.config) || void 0 === i ? void 0 : i.unsubscribeEnabled) && ee.isPushEnabled() && this.hideCustomLinkContainers()
                }
            })
        }
        setTextFromPushStatus(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                var t, i, n, o;
                (null === (i = null === (t = this.config) || void 0 === t ? void 0 : t.text) || void 0 === i ? void 0 : i.subscribe) && (ee.isPushEnabled() || (e.textContent = this.config.text.subscribe)), (null === (o = null === (n = this.config) || void 0 === n ? void 0 : n.text) || void 0 === o ? void 0 : o.unsubscribe) && ee.isPushEnabled() && (e.textContent = this.config.text.unsubscribe)
            })
        }
        setCustomColors(e) {
            var t, i, n, o, s, r, a;
    ...
    class te {
        ...
        static checkAndTriggerSubscriptionChanged() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                const e = yield OneSignal.context.subscriptionManager.getSubscriptionState(), t = yield OneSignal.privateIsPushNotificationsEnabled(), i = yield y.a.getAppState(), {
                    lastKnownPushEnabled: n
                } = i;
                (null === n || t !== n) && (a.a.info("The user's subscription state changed from " + `${null===n?"(not stored)":n} âŸ¶ ${e.subscribed}`), b.setIsPushNotificationsEnabled(t), i.lastKnownPushEnabled = t, yield y.a.setAppState(i), te.triggerSubscriptionChanged(t))
            })
        }
        static _onSubscriptionChanged(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                te.onSubscriptionChanged_showWelcomeNotification(e), te.onSubscriptionChanged_sendCategorySlidedownTags(e), te.onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate(), te.onSubscriptionChanged_updateCustomLink()
            })
        }
        static onSubscriptionChanged_sendCategorySlidedownTags(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                J.a.isCategorySlidedownConfigured(n) && (yield OneSignal.context.tagManager.sendTags(!1))
            })
        }
        static onSubscriptionChanged_showWelcomeNotification(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                if (OneSignal.__doNotShowWelcomeNotification) a.a.debug("Not showing welcome notification because user has previously subscribed.");
                else if (!0 === e) {
                    const {
                        deviceId: e
                    } = yield y.a.getSubscription(), {
                        appId: t
                    } = yield y.a.getAppConfig(), i = OneSignal.config.userConfig.welcomeNotification, n = void 0 !== i && !0 === i.disable;
                    let o = void 0 !== i && void 0 !== i.title && null !== i.title ? i.title : "",
                    ...
                    o = Y.a.decodeHtmlEntities(o), s = Y.a.decodeHtmlEntities(s), n || (a.a.debug("Sending welcome notification."), U.a.sendNotification(t, [e], {
                        en: o
                    }, {
                        en: s
                    }, c, null, {
                        __isOneSignalWelcomeNotification: !0
                    }, void 0), P.a.trigger(OneSignal.EVENTS.WELCOME_NOTIFICATION_SENT, {
                        title: o,
                        message: s,
                        url: c
                    }))
        ...
        static onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (e && "function" == typeof e && OneSignal.notifyButton) {
                    !1 !== (yield e()) ? (a.a.debug("Showing notify button because display predicate returned true."), OneSignal.notifyButton.launcher.show()) : (a.a.debug("Hiding notify button because display predicate returned false."), OneSignal.notifyButton.launcher.hide())
                }
            })
        }
        ...
        static fireStoredNotificationClicks(e = document.URL) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if ("origin" === (yield y.a.get("Options", "notificationClickHandlerMatch"))) {
    ...
    class oe {
        ...
        static internalRegisterForPush(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (e && !t.pageViewManager.isFirstPageView()) {
                    a.a.debug("Not registering for push because the user is subscribed and this is not the first page view."), a.a.debug("But we want to rekindle their session.");
                    const e = yield se.getDeviceId();
                    if (e) {
                        const t = yield se.createDeviceRecord(OneSignal.config.appId, !0);
                        yield OneSignal.context.sessionManager.upsertSession(e, t, ne.b.PageRefresh)
                    } else a.a.error("Should have been impossible to have push as enabled but no device id.");
                    return null
                }
                ...
                switch (s.a.getWindowEnv()) {
                    ...
                    case r.a.OneSignalSubscriptionModal:
                        try {
                            ...
                            i = yield t.subscriptionManager.registerSubscription(e), t.pageViewManager.incrementPageViewCount(), yield z.a.triggerNotificationPermissionChanged(), yield te.checkAndTriggerSubscriptionChanged()
                        } catch (e) {
                            a.a.info(e)
                        }
                        break;
                    case r.a.OneSignalSubscriptionPopup:
                        ...
                        try {
                            o = yield t.subscriptionManager.subscribe(1), yield t.permissionManager.updateStoredPermission()
                        } catch (i) {
                            if (yield t.permissionManager.updateStoredPermission(), i instanceof V) switch (i.reason) {
                                case j.Blocked:
                        ...
                        OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.FINISH_REMOTE_REGISTRATION, {
                            ...
                            !0 === t.data.progress ? (a.a.debug("Got message from host page that remote reg. is in progress, closing popup."), e && window.close()) : a.a.debug("Got message from host page that remote reg. could not be finished.")
                        });
                        break;
                    default:
                        throw "undefined" != typeof OneSignal && (OneSignal._isRegisteringForPush = !1), new B(M.UnsupportedEnvironment)
                }
        ...
        static getRawPushSubscriptionForSafari(e) {
            const t = new W.a,
                {
                    deviceToken: i
                } = window.safari.pushNotification.permission(e);
        ...
        static getRawPushSubscription(e, t) {
            return Object(c.a)(this, void 0, void 0, function*() {
                if (e.browserType === ie.Safari) return oe.getRawPushSubscriptionForSafari(t);
                if (e.isUsingSubscriptionWorkaround) return oe.getRawPushSubscriptionWhenUsingSubscriptionWorkaround();
                if (e.isBrowserAndSupportsServiceWorkers) {
                    const e = yield OneSignal.context.serviceWorkerManager.getRegistration();
                    return yield oe.getRawPushSubscriptionFromServiceWorkerRegistration(e)
                }
                return null
            })
        }
    ...
    class se {
        static getCurrentNotificationType() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (e === n.Denied) return d.a.isUsingSubscriptionWorkaround() ? R.a.Default : R.a.NotSubscribed;
                const t = yield OneSignal.context.subscriptionManager.isAlreadyRegisteredWithOneSignal();
                if (e === n.Granted && t) {
                    return (yield OneSignal.privateIsPushNotificationsEnabled()) ? R.a.Subscribed : R.a.MutedByApi
                }
                return R.a.Default
            })
        }
        ...
        static checkAndTriggerNotificationPermissionChanged() {
            return Object(c.a)(this, void 0, void 0, function*() {
                const e = yield y.a.get("Options", "notificationPermission"), t = yield OneSignal.getNotificationPermission();
                e !== t && (yield z.a.triggerNotificationPermissionChanged(), yield y.a.put("Options", {
                    key: "notificationPermission",
                    value: t
                }))
            })
        ...
        static getNotificationIcons() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (i.errors) throw a.a.error(`API call %c${t}`, x.a.getConsoleStyle("code"), "failed with:", i.errors), new Error("Failed to get notification icons.");
                return i
            })
        }
        static getSlidedownOptions(e) {
            return x.a.getValueOrDefault(e.slidedown, {
                prompts: []
            })
        }
        ...
        static getPromptOptionsQueryString() {
            let e = "";
            if (se.getFullscreenPermissionMessageOptions(OneSignal.config.userConfig.promptOptions)) {
        ...
        static getPromptOptionsPostHash() {
            const e = se.getFullscreenPermissionMessageOptions(OneSignal.config.userConfig.promptOptions);
            if (e) {
                var t = {
        ...
        static triggerCustomPromptClicked(e) {
            P.a.trigger(OneSignal.EVENTS.CUSTOM_PROMPT_CLICKED, {
                result: e
            })
        }
        static getAppId() {
        ...
        static createDeviceRecord(e, t = !1) {
            return Object(c.a)(this, void 0, void 0, function*() {
                let i;
                if (t) {
                    const e = yield oe.getRawPushSubscription(OneSignal.environmentInfo, OneSignal.config.safariWebId);
                    e && (i = e)
                }
                const n = new F.a(i);
                return n.appId = e, n.subscriptionState = yield se.getCurrentNotificationType(), n
            })
        }
        static getDeviceId() {
            return Object(c.a)(this, void 0, void 0, function*() {
    ...
    class ae {
        ...
        getDeviceId() {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (!e) throw new NotSubscribedError.a(NotSubscribedError.b.NoDeviceId);
                return e
            })
        }
        createDeviceRecord() {
        ...
        sendPushDeviceRecordUpdate(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                if (!(yield this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal())) return void a.a.debug("Not sending the update because user is not registered with OneSignal (no device id)");
                const t = yield this.getDeviceId();
                e || (e = yield this.createDeviceRecord()), this.onSessionSent ? yield U.a.updatePlayer(this.context.appConfig.appId, t, Object.assign({
        ...
        sendOnSessionUpdate(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (!(yield this.context.subscriptionManager.isAlreadyRegisteredWithOneSignal())) return void a.a.debug("Not sending the on session because user is not registered with OneSignal (no device id)");
                const t = yield this.getDeviceId();
                if (e || (e = yield this.createDeviceRecord()), e.subscriptionState === R.a.Subscribed || !0 === OneSignal.config.enableOnSession) try {
                    this.context.sessionManager.upsertSession(t, e, ne.b.PlayerOnSession), this.onSessionSent = !0
                } catch (e) {
                    a.a.error(`Failed to update user session. Error "${e.message}" ${e.stack}`)
                }
            })
        }
        sendPlayerCreate(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    return t ? (a.a.info("Subscribed to web push and registered with OneSignal", e, t), this.onSessionSent = !0, this.context.sessionManager.upsertSession(t, e, ne.b.PlayerCreate), t) : void a.a.error("Failed to create user.")
                } catch (e) {
                    return void a.a.error(`Failed to create user. Error "${e.message}" ${e.stack}`)
                }
            })
        }
        ...
        sendPushPlayerUpdate(e) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                if (t || (yield Object(Z.c)(OneSignal.EVENTS.REGISTERED), ({
                        deviceId: t
                    } = yield y.a.getSubscription())), t) return yield U.a.updatePlayer(this.context.appConfig.appId, t, e)
            })
        }
        sendOutcomeDirect(e, t, i, n) {
            return Object(c.a)(this, void 0, void 0, function*() {
                Object(Z.e)("sendOutcomeDirect");
                const o = yield this.createDeviceRecord(), s = {
                    app_id: e,
                    id: i,
        ...
        sendOutcomeUnattributed(e, t, i) {
            return Object(c.a)(this, void 0, void 0, function*() {
                ...
                const n = yield this.createDeviceRecord(), o = {
                    app_id: e,
                    id: t,
    ...
    class ue {
        constructor(e) {
            this.appConfig = e, this.subscriptionManager = G.getSubscriptionManager(this), this.serviceWorkerManager = G.getServiceWorkerManager(this), this.pageViewManager = new v, this.sessionManager = new ce(this), this.permissionManager = new p, this.workerMessenger = new o.a(this), this.updateManager = new ae(this), this.secondaryChannelManager = new de.a
        }
    }
}, function(e, t, i) {
    "use strict";
    ...
    class g {
        ...
        static downloadServerAppConfig(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                return d.a.getWindowEnv() !== u.a.ServiceWorker ? yield new Promise((t, i) => {
                    g.jsonpLib(`${d.a.getOneSignalApiUrl().toString()}/sync/${e}/web`, (e, n) => {
    ...
    class b {
        constructor(e, t, i, n, o) {
            this.secondaryChannelIdentifierUpdater = e, this.secondaryChannelExternalUserIdUpdater = t, this.secondaryChannelTagsUpdater = i, this.secondaryChannelSessionUpdater = n, this.secondaryChannelFocusUpdater = o
        }
        logout() {
            return Object(n.a)(this, void 0, void 0, function*() {
                const e = yield f.a.getEmailProfile();
                if (!e.subscriptionId) return s.a.warn(new NotSubscribedError.a(NotSubscribedError.b.NoEmailSet)), !1;
                const {
                    deviceId: t
                } = yield f.a.getSubscription();
                if (!t) return s.a.warn(new NotSubscribedError.a(NotSubscribedError.b.NoDeviceId)), !1;
                const i = yield f.a.getAppConfig();
                return (yield g.logoutEmail(i, e, t)) ? (yield f.a.setEmailProfile(new r.a), !0) : (s.a.warn("Failed to logout email."), !1)
            })
        }
        setIdentifier(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const {
                    profileProvider: i
                } = this.secondaryChannelIdentifierUpdater, n = yield i.getProfile(), o = yield this.secondaryChannelIdentifierUpdater.setIdentifier(e, t), s = o.subscriptionId;
                if (s) {
                    const t = i.newProfile(s, e);
                    yield this.updatePushPlayersRelationToEmailPlayer(n, t)
                }
                return yield h.a.trigger(OneSignal.EVENTS.EMAIL_SUBSCRIPTION_CHANGED, {
                    email: o.identifier
                }), s
            })
        }
        updatePushPlayersRelationToEmailPlayer(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const {
                    deviceId: i
                } = yield f.a.getSubscription(), n = i, o = !!!e.subscriptionId || e.subscriptionId !== t.subscriptionId, s = !e.identifier || t.identifier !== e.identifier;
                if (i && n && (o || s)) {
                    const e = yield OneSignal.database.getExternalUserIdAuthHash(), n = yield f.a.getAppConfig();
    ...
    class y extends S.a {
        constructor(e, t, i, n) {
            super(), this.deliveryPlatform = e, this.identifier = t, this.identifierAuthHash = i, this.pushDeviceRecordId = n
        }
        serialize() {
            const e = super.serialize();
            return this.identifier && (e.identifier = this.identifier), this.identifierAuthHash && (e.identifier_auth_hash = this.identifierAuthHash), this.pushDeviceRecordId && (e.device_player_id = this.pushDeviceRecordId), e
        }
        deserialize(e) {
            throw new m.a
        }
    ...
    class O {
        ...
        setIdentifier(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const i = yield f.a.getAppConfig(), n = yield this.profileProvider.getProfile(), o = this.profileProvider.newProfile(n.subscriptionId, e, t);
                if (n.subscriptionId) yield g.updatePlayer(i.appId, n.subscriptionId, {
                    identifier: e,
                    ...
                    const {
                        deviceId: e
                    } = yield f.a.getSubscription(), t = new y(this.profileProvider.deviceType, o.identifier, o.identifierAuthHash, e);
                    t.appId = i.appId, yield v.a.addExternalUserIdToDeviceRecord(t), o.subscriptionId = yield g.createUser(t)
                }
                return o.subscriptionId && (yield this.profileProvider.setProfile(o)), o
            })
        }
    }
    class w {
        ...
        sendTags(e) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const t = yield this.profileProvider.getSubscriptionId(), {
                    appId: i
                } = yield f.a.getAppConfig(), n = (yield this.profileProvider.getProfile()).identifierAuthHash, o = {
                    tags: e,
    ...
    class C {
        ...
        sendOnSession() {
            return Object(n.a)(this, void 0, void 0, function*() {
                ...
                const t = new y(this.profileProvider.deviceType, e.identifier, e.identifierAuthHash),
                    i = yield f.a.getAppConfig();
                t.appId = i.appId;
                const n = yield p.a.updateUserSession(e.subscriptionId, t);
                n !== e.subscriptionId && (e.subscriptionId = n, yield this.profileProvider.setProfile(e))
            })
        }
    }
    var E = i(30);
    ...
    class M {
        ...
        logout() {
            return Object(n.a)(this, void 0, void 0, function*() {
                return (yield f.a.getSMSProfile()).subscriptionId ? (yield f.a.setSMSProfile(new A.a), !0) : (s.a.warn(new NotSubscribedError.a(NotSubscribedError.b.NoSMSSet)), !1)
            })
        }
        setIdentifier(e, t) {
            return Object(n.a)(this, void 0, void 0, function*() {
                const i = yield this.secondaryChannelIdentifierUpdater.setIdentifier(e, t);
                return yield h.a.trigger(OneSignal.EVENTS.SMS_SUBSCRIPTION_CHANGED, {
                    sms: i.identifier
                }), i.subscriptionId
            })
        }
    ...
    class O {
        static upgradeConfigToVersionTwo(e) {
            var t, i, n;
            O.isPromptOptionsVersion0(e.promptOptions) && (e.promptOptions = O.convertConfigToVersionOne(e.promptOptions)), O.isSlidedownConfigVersion1(null === (t = e.promptOptions) || void 0 === t ? void 0 : t.slidedown) && (null === (i = e.promptOptions) || void 0 === i ? void 0 : i.slidedown) && (e.promptOptions.slidedown = O.convertConfigToVersionTwo(null === (n = e.promptOptions) || void 0 === n ? void 0 : n.slidedown))
        }
        ...
        static convertConfigToVersionTwo(e) {
            var t, i, n, o;
            const s = y.a.isCategorySlidedownConfiguredVersion1(e) ? l.a.Category : l.a.Push;
            let r, a;
            return s === l.a.Category && (r = null === (t = e.categories) || void 0 === t ? void 0 : t.positiveUpdateButton, a = null === (i = e.categories) || void 0 === i ? void 0 : i.negativeUpdateButton), {
                prompts: [...e.prompts || [], {
                    type: s,
    ...
    i.d(t, "a", function() {
        return P
    }), (S = m || (m = {}))[S.Dashboard = 0] = "Dashboard", S[S.JavaScript = 1] = "JavaScript";
    const w = 10;
    class P {
        static getAppConfig(e, t) {
            return Object(r.a)(this, void 0, void 0, function*() {
                try {
                    if (!e || !e.appId || !d.b.isValidUuid(e.appId)) throw new SdkInitError.a(SdkInitError.b.InvalidAppId);
        ...
        static checkRestrictedOrigin(e) {
            if (e.restrictedOriginEnabled && c.a.getWindowEnv() !== a.a.ServiceWorker && window.top === window && !u.b.contains(window.location.hostname, ".os.tc") && !u.b.contains(window.location.hostname, ".onesignal.com") && !this.doesCurrentOriginMatchConfigOrigin(e.origin)) throw new SdkInitError.a(SdkInitError.b.WrongSiteUrl, {
                siteUrl: e.origin
            })
        }
        ...
        static getIntegrationCapabilities(e) {
            switch (e) {
                ...
                case n.WordPress:
                    return {
                        configuration: m.JavaScript
                    };
                default:
                    return {
                        configuration: m.Dashboard
                    }
            }
        }
        static getMergedConfig(e, t) {
            ...
            return {
                ...
                userConfig: r,
                enableOnSession: u.b.valueOrDefault(t.features.enable_on_session, p.enableOnSessionForUnsubcribed),
                sessionThreshold: u.b.valueOrDefault(t.features.session_threshold, p.reportingThreshold),
                enableSessionDuration: u.b.valueOrDefault(t.features.web_on_focus_enabled, p.enableOnFocus)
            }
        }
        ...
        static injectDefaultsIntoPromptOptions(e, t, i, n = !1) {
            ...
            const a = t.customlink,
                c = Object.assign(Object.assign({}, e), {
                    customlink: {
                        ...
                        unsubscribeEnabled: u.b.getValueOrDefault(r.unsubscribeEnabled, a.unsubscribeEnabled),
                        text: {
                            subscribe: u.b.getValueOrDefault(r.text ? r.text.subscribe : void 0, a.text.subscribe),
                            unsubscribe: u.b.getValueOrDefault(r.text ? r.text.unsubscribe : void 0, a.text.unsubscribe),
                            explanation: u.b.getValueOrDefault(r.text ? r.text.explanation : void 0, a.text.explanation)
                        },
                        color: {
                            button: u.b.getValueOrDefault(r.color ? r.color.button : void 0, a.color.button),
                            text: u.b.getValueOrDefault(r.color ? r.color.text : void 0, a.color.text)
                        }
                    }
                });
            if (c.slidedown ? c.slidedown.prompts = null === (s = null === (o = c.slidedown) || void 0 === o ? void 0 : o.prompts) || void 0 === s ? void 0 : s.map(e => {
                    ...
                    if (e.type = u.b.getValueOrDefault(e.type, l.a.Push), e.type === l.a.Category && (e.text = Object.assign(Object.assign({}, e.text), {
                            positiveUpdateButton: u.b.getValueOrDefault(null === (t = e.text) || void 0 === t ? void 0 : t.positiveUpdateButton, f.categoryDefaults.positiveUpdateButton),
                            negativeUpdateButton: u.b.getValueOrDefault(null === (i = e.text) || void 0 === i ? void 0 : i.negativeUpdateButton, f.categoryDefaults.negativeUpdateButton),
                            updateMessage: u.b.getValueOrDefault(null === (n = e.text) || void 0 === n ? void 0 : n.updateMessage, f.categoryDefaults.updateMessage)
                        })), e.text = Object.assign(Object.assign({}, e.text), {
                            actionMessage: u.b.getValueOrDefault(null === (o = e.text) || void 0 === o ? void 0 : o.actionMessage, f.actionMessage),
                            acceptButton: u.b.getValueOrDefault(null === (s = e.text) || void 0 === s ? void 0 : s.acceptButton, f.acceptButton),
                            cancelButton: u.b.getValueOrDefault(null === (r = e.text) || void 0 === r ? void 0 : r.cancelButton, f.cancelButton),
                            confirmMessage: u.b.getValueOrDefault(null === (a = e.text) || void 0 === a ? void 0 : a.confirmMessage, f.confirmMessage)
                        }), e.autoPrompt = u.b.getValueOrDefault(e.autoPrompt, !0), e.delay = {
                            pageViews: u.b.getValueOrDefault(null === (c = e.delay) || void 0 === c ? void 0 : c.pageViews, g.pageViews),
                            timeDelay: u.b.getValueOrDefault(null === (d = e.delay) || void 0 === d ? void 0 : d.timeDelay, g.timeDelay)
                        }, e.categories) {
                        const {
                            categories: t
                        } = e;
            ...
            return c.autoPrompt = c.native.autoPrompt || y.a.isSlidedownAutoPromptConfigured(c.slidedown.prompts), c
        }
        static getPromptOptionsForDashboardConfiguration(e) {
            const t = e.config.staticPrompts,
                i = t.native ? {
                    ...
                    pageViews: u.b.getValueOrDefault(t.native.pageViews, g.pageViews),
                    timeDelay: u.b.getValueOrDefault(t.native.timeDelay, g.timeDelay)
                } : {
                    enabled: !1,
                    autoPrompt: !1,
                    pageViews: g.pageViews,
        ...
        static getUserConfigForConfigIntegrationKind(e, t, i, n = !1) {
            switch (this.getIntegrationCapabilities(e).configuration) {
                case m.Dashboard:
                    return {
                        appId: i.app_id, autoRegister: !1, autoResubscribe: i.config.autoResubscribe, path: i.config.serviceWorker.path, serviceWorkerPath: i.config.serviceWorker.workerName, serviceWorkerParam: {
                ...
                case m.JavaScript:
                    ...
                    return t.hasOwnProperty("autoResubscribe") ? c.autoResubscribe = !!t.autoResubscribe : t.hasOwnProperty("autoRegister") ? c.autoResubscribe = !!t.autoRegister : c.autoResubscribe = !!i.config.autoResubscribe, c
            }
        }
    ...
    e.exports = function(e, t, o) {
        ...
        return window[c] = function(e) {
                g(), o && o(null, e)
            }, e = (e += (~e.indexOf("?") ? "&" : "?") + d + "=" + l(c)).replace("?&", "?"), (s = document.createElement("script")).src = e, p.parentNode.insertBefore(s, p),
            function() {
                window[c] && g()
            }
    };
        ...
        class k {
                ...
                self.addEventListener("message", e => {
                    ...
                    switch (t.command) {
                        case a.b.SessionUpsert:
                            b.a.debug("[Service Worker] Received SessionUpsert", i), k.debounceRefreshSession(e, i);
                            break;
                        case a.b.SessionDeactivate:
                            b.a.debug("[Service Worker] Received SessionDeactivate", i), k.debounceRefreshSession(e, i);
                            break;
                        default:
                            return
                    }
            ...
            static setupMessageListeners() {
                k.workerMessenger.on(a.b.WorkerVersion, e => {
                    b.a.debug("[Service Worker] Received worker version message."), k.workerMessenger.broadcast(a.b.WorkerVersion, r.a.version())
                }), k.workerMessenger.on(a.b.Subscribe, e => Object(n.a)(this, void 0, void 0, function*() {
                    const t = e;
                ...
                })), k.workerMessenger.on(a.b.SubscribeNew, e => Object(n.a)(this, void 0, void 0, function*() {
                    const t = e;
                ...
                })), k.workerMessenger.on(a.b.AmpSubscriptionState, e => Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    if (e) {
                        ...
                        yield k.workerMessenger.broadcast(a.b.AmpSubscriptionState, n)
                    } else yield k.workerMessenger.broadcast(a.b.AmpSubscriptionState, !1)
                })), k.workerMessenger.on(a.b.AmpSubscribe, () => Object(n.a)(this, void 0, void 0, function*() {
                    b.a.debug("[Service Worker] Received AMP subscribe message.");
                    const e = yield k.getAppId(), t = yield v.a.getAppConfig({
                        appId: e
                    }, u.b.downloadServerAppConfig), i = new c.a(t), n = yield i.subscriptionManager.subscribe(0), o = yield i.subscriptionManager.registerSubscription(n);
                    yield l.a.put("Ids", {
                        type: "appId",
                        id: e
                    }), k.workerMessenger.broadcast(a.b.AmpSubscribe, o.deviceId)
                })), k.workerMessenger.on(a.b.AmpUnsubscribe, () => Object(n.a)(this, void 0, void 0, function*() {
                    b.a.debug("[Service Worker] Received AMP unsubscribe message.");
                    const e = yield k.getAppId(), t = yield v.a.getAppConfig({
                        appId: e
                    }, u.b.downloadServerAppConfig);
                    yield new c.a(t).subscriptionManager.unsubscribe(1), k.workerMessenger.broadcast(a.b.AmpUnsubscribe, null)
                })), k.workerMessenger.on(a.b.AreYouVisibleResponse, e => Object(n.a)(this, void 0, void 0, function*() {
                    if (b.a.debug("[Service Worker] Received response for AreYouVisible", e), !self.clientsStatus) return;
                    const t = e.timestamp;
            ...
            static onPushReceived(e) {
                b.a.debug(`Called %conPushReceived(${JSON.stringify(e,null,4)}):`, S.a.getConsoleStyle("code"), e), e.waitUntil(k.parseOrFetchNotifications(e).then(e => Object(n.a)(this, void 0, void 0, function*() {
                    const t = [],
                        i = [],
                        n = yield k.getAppId();
                    for (const o of e) {
                        ...
                        i.push(l.a.put("NotificationReceived", s)), t.push((e => k.displayNotification(e).then(() => k.workerMessenger.broadcast(a.b.NotificationDisplayed, e).catch(e => b.a.error(e))).then(() => k.executeWebhooks("notification.displayed", e).then(() => k.sendConfirmedDelivery(e)).catch(e => b.a.error(e)))).bind(null, e))
                    }
                    return t.reduce((e, t) => e.then(t), Promise.resolve())
                })).catch(e => {
                    b.a.debug("Failed to display a notification:", e), k.UNSUBSCRIBED_FROM_NOTIFICATIONS && b.a.debug("Because we have just unsubscribed from notifications, we will not show anything.")
                }))
            }
            static executeWebhooks(e, t) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    const {
                        deviceId: n
                    } = yield l.a.getSubscription(), o = yield l.a.get("Options", "webhooks.cors"), s = {
                        event: e,
                        id: t.id,
                        userId: n,
                        action: t.action,
                    ...
                    return o && (r.mode = "cors", r.headers = {
                        "X-OneSignal-Event": e,
                        "Content-Type": "application/json"
                    }), b.a.debug(`Executing ${e} webhook ${o?"with":"without"} CORS %cPOST ${i}`, S.a.getConsoleStyle("code"), ":", s), yield fetch(i, r)
                })
            }
            static sendConfirmedDelivery(e) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    return b.a.debug(`Called %csendConfirmedDelivery(${JSON.stringify(e,null,4)})`, S.a.getConsoleStyle("code")), yield Object(P.a)(Math.floor(Math.random() * I * 1e3)), yield d.b.put(`notifications/${e.id}/report_received`, n)
                })
            }
            static getActiveClients() {
                return Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    for (const i of e) {
                        const e = i;
                        if (e.isSubdomainIframe = !1, i.frameType && "nested" === i.frameType) {
                            if (!S.a.contains(i.url, ".os.tc") && !S.a.contains(i.url, ".onesignal.com")) continue;
            ...
            static updateSessionBasedOnHasActive(e, t, i) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    if (t) yield y.b.upsertSession(i.sessionThreshold, i.enableSessionDuration, i.deviceRecord, i.deviceId, i.sessionOrigin, i.outcomesConfig);
                    else {
                        const t = yield y.b.deactivateSession(i.sessionThreshold, i.enableSessionDuration, i.outcomesConfig);
            ...
            static refreshSession(e, t) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    if (b.a.debug("[Service Worker] refreshSession"), t.isHttps) {
                        ...
                        if (t.isSafari) yield k.checkIfAnyClientsFocusedAndUpdateSession(e, i, t);
                        else {
                            const n = i.some(e => e.focused);
                            b.a.debug("[Service Worker] isHttps hasAnyActiveSessions", n), yield k.updateSessionBasedOnHasActive(e, n, t)
                        }
                    } else {
                ...
                return Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    t.forEach(e => {
                        self.clientsStatus && self.clientsStatus.sentRequestsCount++, e.postMessage({
                            command: a.b.AreYouVisible,
                            payload: s
                        })
                    });
                    const r = Object(O.a)(() => Object(n.a)(this, void 0, void 0, function*() {
                        self.clientsStatus && self.clientsStatus.timestamp === o && (b.a.debug("updateSessionBasedOnHasActive", self.clientsStatus), yield k.updateSessionBasedOnHasActive(e, self.clientsStatus.hasAnyActiveSessions, i), self.clientsStatus = void 0)
                    }), .5);
                    self.cancel = r.cancel, e.waitUntil(r.promise)
                })
            }
            static debounceRefreshSession(e, t) {
                b.a.debug("[Service Worker] debounceRefreshSession", t), self.cancel && (self.cancel(), self.cancel = void 0);
                const i = Object(O.a)(() => Object(n.a)(this, void 0, void 0, function*() {
            ...
            static buildStructuredNotificationObject(e) {
                ...
                if (e.o) {
                    t.buttons = [];
                    for (const i of e.o) t.buttons.push({
                        action: i.i,
                        title: i.n,
                        icon: i.p,
                        url: i.u
            ...
            static ensureNotificationResourcesHttps(e) {
                if (e && (e.icon && (e.icon = k.ensureImageResourceHttps(e.icon)), e.image && (e.image = k.ensureImageResourceHttps(e.image)), e.buttons && e.buttons.length > 0))
                    for (const t of e.buttons) t.icon && (t.icon = k.ensureImageResourceHttps(t.icon))
            }
            static displayNotification(e, t) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    b.a.debug(`Called %cdisplayNotification(${JSON.stringify(e,null,4)}):`, S.a.getConsoleStyle("code"), e);
                    const i = yield k._getTitle(), n = yield l.a.get("Options", "defaultIcon"), o = yield l.a.get("Options", "persistNotification"), s = yield k.getAppId();
                    e.heading = e.heading ? e.heading : i, e.icon = e.icon ? e.icon : n || void 0;
                    const r = {};
                    r.tag = e.tag || s, r.persistNotification = !1 !== o, t || (t = {}), e = Object.assign(Object.assign({}, e), t), k.ensureNotificationResourcesHttps(e);
                    const a = {
                        body: e.content,
                        icon: e.icon,
                        image: e.image,
            ...
            static onNotificationClosed(e) {
                b.a.debug(`Called %conNotificationClosed(${JSON.stringify(e,null,4)}):`, S.a.getConsoleStyle("code"), e);
                const t = e.notification.data;
                k.workerMessenger.broadcast(a.b.NotificationDismissed, t).catch(e => b.a.error(e)), e.waitUntil(k.executeWebhooks("notification.dismissed", t))
            }
            static getNotificationUrlToOpen(e) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    if (i && (t = i), e.action)
                        for (const i of e.buttons) i.action === e.action && i.url && "" !== i.url && (t = i.url);
            ...
            static onNotificationClicked(e) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    b.a.debug(`Called %conNotificationClicked(${JSON.stringify(e,null,4)}):`, S.a.getConsoleStyle("code"), e), e.notification.close();
                    const t = e.notification.data;
                    ...
                    r && (o = r);
                    const c = yield k.getNotificationUrlToOpen(t), d = k.shouldOpenNotificationUrl(c), u = yield k.getAppId(), p = w.a.prototype.getDeliveryPlatform();
                    let g;
                    const f = {
                        notificationId: t.id,
                        appId: u,
                    ...
                    b.a.info("NotificationClicked", f), g = (e => Object(n.a)(this, void 0, void 0, function*() {
                        try {
                            const t = yield l.a.getCurrentSession();
                            if (t && t.status === h.c.Active) return;
                            yield l.a.put("NotificationClicked", e), t && (t.notificationId = e.notificationId, yield l.a.upsertSession(t))
                        } catch (e) {
                    ...
                    const {
                        deviceId: v
                    } = yield l.a.getSubscription(), m = k.sendConvertedAPIRequests(u, v, t, p), y = yield k.getActiveClients();
                    let O = !1;
                    for (const e of y) {
                        let n = e.url;
                        ...
                        if ("exact" === i && n === c || "origin" === i && s === r) {
                            if (e.isSubdomainIframe && n === c || !e.isSubdomainIframe && e.url === c || "focus" === o && s === r) {
                                ...
                                d ? (b.a.debug(`Redirecting HTTP site to ${c}.`), yield l.a.put("NotificationOpened", {
                                    url: c,
                                    data: t,
                                    timestamp: Date.now()
                                }), k.workerMessenger.unicast(a.b.RedirectPage, c, e)) : b.a.debug("Not navigating because link is special.")
                                ...
                                try {
                                    d ? (b.a.debug(`Redirecting HTTPS site to (${c}).`), yield l.a.put("NotificationOpened", {
                                        url: c,
                                        data: t,
                                        timestamp: Date.now()
                    ...
                    return d && !O && (yield l.a.put("NotificationOpened", {
                        url: c,
                        data: t,
                        timestamp: Date.now()
                    }), yield k.openUrl(c)), g && (yield g), yield m
                })
            }
            static sendConvertedAPIRequests(e, t, i, o) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    ...
                    let n;
                    e ? n = d.b.put(`notifications/${i.id}`, {
                        app_id: e,
                        player_id: t,
                        opened: !0,
                        device_type: o
                    }) : console.error("No app Id, skipping OneSignal API call for notification open!"), yield k.executeWebhooks("notification.clicked", i), n && (yield n)
                })
            }
            static openUrl(e) {
                return Object(n.a)(this, void 0, void 0, function*() {
            ...
            static onServiceWorkerActivated(e) {
                b.a.info(`OneSignal Service Worker activated (version ${r.a.version()})`), e.waitUntil(self.clients.claim())
            }
            static onPushSubscriptionChange(e) {
                return Object(n.a)(this, void 0, void 0, function*() {
                    b.a.debug(`Called %conPushSubscriptionChange(${JSON.stringify(e,null,4)}):`, S.a.getConsoleStyle("code"), e);
                    const t = yield k.getAppId();
                    if (!t) return;
                    ...
                    let o, s; {
                        ...
                        if (!(o = !!i) && e.oldSubscription) {
                            i = yield u.b.getUserIdFromSubscriptionIdentifier(t, f.a.prototype.getDeliveryPlatform(), e.oldSubscription.endpoint);
                    ...
                    if (o || !!s) {
                        let e = null;
                        "granted" !== Notification.permission ? e = g.a.PermissionRevoked : s || (e = g.a.PushSubscriptionRevoked), yield n.subscriptionManager.registerSubscription(s, e)
            ...
            static parseOrFetchNotifications(e) {
                ...
                return k.isValidPushPayload(e.data) ? (b.a.debug("Received a valid encrypted push payload."), Promise.resolve([e.data.json()])) : Promise.reject(`Unexpected push message payload received: ${e.data}`)
            }
            static isValidPushPayload(e) {
                try {
                    const t = e.json();
                    return !!(t && t.custom && t.custom.i && m.a.isValidUuid(t.custom.i)) || (b.a.debug("isValidPushPayload: Valid JSON but missing notification UUID:", t), !1)
                } catch (e) {
